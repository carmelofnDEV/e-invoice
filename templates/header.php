...
?>
    ...
    <header class=" pl-[15%] bg-white fixed top-0 left-0 w-full z-10">
        ...
        <div class="flex justify-between container mx-auto px-4 py-4">
            ...
            <div class="flex gap-4 justify-center items-center">
                ...
                <?php if (isset($add_link)) { ?>
                    <a href="<?= $add_link ?>" id="dropdownCust" class="flex bg-[#1A1917] rounded-md px-3 py-1 justify-center items-center gap-2 " >
                        <p class="text-white font-[500] text-[15px]">Nuevo</p>
            ...
            <div class="flex gap-10 justify-center items-center">
                ...
                <div class="flex gap-3">
                    ...
                    <div class="flex flex-col justify-center items-center text-[12px] font-[700]">
                        <p><?=$user["first_name"]?></p>
    ...
    <div class="w-[15%] z-20 min-h-screen top-0 bg-[#1A1917]">
        <ul class="w-[13%] fixed  py-3 font-medium text-[#FAFAFA] ">
            ...
            <!-- Pop Pover -->
            <li class=" 13 border-[#c8c8c8] !border-b-[1px]">

                <div class="pl-5 pr-10 pb-5 flex justify-center items-center flex-col">

                    <a href="/" class="mb-4 flex jutify-center items-center gap-3">
                        ...
                        <div data-popover id="popover-bottom" role="tooltip" class="mt-10 absolute z-10 invisible  transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 ">
                            <ul class="p-1 w-[150px] text-black flex flex-col justify-center items-center  gap-1">
                                ...
                                <li class="w-full hover:bg-[#c3c3c3] m-1 text-center rounded">
                                    <a class="flex gap-2 justify-start items-center transition-all hover:opacity-100  opacity-60 p-1 " href="/documento/nuevo?doc=factura">
                                ...
                                <li class="w-full hover:bg-[#c3c3c3] m-1 text-center rounded">
                                    <a class="flex gap-2 justify-start items-center transition-all hover:opacity-100  opacity-60 p-1 " href="/documento/nuevo?doc=rectificativa">
                                        <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 193.769 193.769" xml:space="preserve"><path d="m149.203 41.104-9.348 12.009c20.15 15.679 30.201 41.063 26.234 66.253-2.906 18.484-12.838 34.73-27.964 45.748-15.131 11.012-33.64 15.488-52.124 12.567-38.157-6.008-64.32-41.938-58.322-80.098C30.585 79.097 40.52 62.85 55.648 51.835c13.208-9.615 28.991-14.233 45.086-13.317L87.579 52.319l9.759 9.313 20.766-21.801.005.008 9.303-9.769-9.752-9.303-.005.003L95.862 0l-9.31 9.769 14.2 13.525c-19.303-.913-38.21 4.702-54.059 16.242C28.28 52.943 16.19 72.717 12.65 95.221c-7.302 46.445 24.54 90.184 70.985 97.493a86 86 0 0 0 13.434 1.055c17.89 0 35.273-5.623 50.011-16.356 18.415-13.409 30.503-33.183 34.043-55.682 4.829-30.654-7.403-61.55-31.92-80.627"/><path d="M105.24 151.971v-.003h.001v-8.757c10.383-1.159 20.485-7.718 20.485-20.17 0-16.919-15.732-18.859-27.223-20.274-7.347-.878-12.97-1.897-12.97-6.348 0-6.188 8.722-6.855 12.473-6.855 5.567 0 11.507 2.617 13.525 5.957l.586.971 11.542-5.341-.571-1.164c-4.301-8.793-12.009-11.337-17.85-12.364v-7.71H91.723v7.677c-12.582 1.856-20.054 8.839-20.054 18.829 0 16.29 14.791 17.943 25.582 19.153 9.617 1.134 14.094 3.51 14.094 7.469 0 7.563-10.474 8.154-13.685 8.154-7.147 0-14.038-3.566-16.031-8.301l-.495-1.169-12.539 5.316.5 1.169c3.713 8.691 11.725 14.137 22.63 15.425v8.336z"/></svg>
                                        <p>Rectificativa</p>
                                    </a>
                                </li>

                                <li class="w-full hover:bg-[#c3c3c3] m-1 text-center rounded">
                                    <a class="flex gap-2 justify-start items-center transition-all hover:opacity-100  opacity-60 p-1 " href="/documento/nuevo?doc=gasto">
                                ...
                                <li class="w-full hover:bg-[#c3c3c3] m-1 text-center rounded">
                                    <a class="flex gap-2 justify-start items-center transition-all hover:opacity-100  opacity-60 p-1 " href="/documento/nuevo?doc=presupuesto">
            ...
            <li>
                <a href="/" class="flex gap-2 pl-5 pr-10 py-4 hover:bg-[#201f1d] border-[#c8c8c8] !border-b-[1px]">
            ...
            <li>
                <a href="/facturas/" class="flex gap-2 pl-5 pr-10 py-4 hover:bg-[#201f1d] border-[#c8c8c8] !border-b-[1px]">
                    <svg width="20px" height="20px" viewBox="0 0 24 24" fill="nonXe" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M6.55281 1.60553C7.10941 1.32725 7.77344 1 9 1C10.2265 1 10.8906 1.32722 11.4472 1.6055L11.4631 1.61347C11.8987 1.83131 12.2359 1.99991 13 1.99993C14.2371 1.99998 14.9698 1.53871 15.2141 1.35512C15.5944 1.06932 16.0437 1.09342 16.3539 1.2369C16.6681 1.38223 17 1.72899 17 2.24148L17 13H20C21.6562 13 23 14.3415 23 15.999V19C23 19.925 22.7659 20.6852 22.3633 21.2891C21.9649 21.8867 21.4408 22.2726 20.9472 22.5194C20.4575 22.7643 19.9799 22.8817 19.6331 22.9395C19.4249 22.9742 19.2116 23.0004 19 23H5C4.07502 23 3.3148 22.7659 2.71092 22.3633C2.11331 21.9649 1.72739 21.4408 1.48057 20.9472C1.23572 20.4575 1.11827 19.9799 1.06048 19.6332C1.03119 19.4574 1.01616 19.3088 1.0084 19.2002C1.00194 19.1097 1.00003 19.0561 1 19V2.24146C1 1.72899 1.33184 1.38223 1.64606 1.2369C1.95628 1.09341 2.40561 1.06931 2.78589 1.35509C3.03019 1.53868 3.76289 1.99993 5 1.99993C5.76415 1.99993 6.10128 1.83134 6.53688 1.6135L6.55281 1.60553ZM3.00332 19L3 3.68371C3.54018 3.86577 4.20732 3.99993 5 3.99993C6.22656 3.99993 6.89059 3.67269 7.44719 3.39441L7.46312 3.38644C7.89872 3.1686 8.23585 3 9 3C9.76417 3 10.1013 3.16859 10.5369 3.38643L10.5528 3.39439C11.1094 3.67266 11.7734 3.9999 13 3.99993C13.7927 3.99996 14.4598 3.86581 15 3.68373V19C15 19.783 15.1678 20.448 15.4635 21H5C4.42498 21 4.0602 20.8591 3.82033 20.6992C3.57419 20.5351 3.39761 20.3092 3.26943 20.0528C3.13928 19.7925 3.06923 19.5201 3.03327 19.3044C3.01637 19.2029 3.00612 19.1024 3.00332 19ZM19.3044 20.9667C19.5201 20.9308 19.7925 20.8607 20.0528 20.7306C20.3092 20.6024 20.5351 20.4258 20.6992 20.1797C20.8591 19.9398 21 19.575 21 19V15.999C21 15.4474 20.5529 15 20 15H17L17 19C17 19.575 17.1409 19.9398 17.3008 20.1797C17.4649 20.4258 17.6908 20.6024 17.9472 20.7306C18.2075 20.8607 18.4799 20.9308 18.6957 20.9667C18.8012 20.9843 18.8869 20.9927 18.9423 20.9967C19.0629 21.0053 19.1857 20.9865 19.3044 20.9667Z" fill="#FAFAFA"></path> <path d="M5 8C5 7.44772 5.44772 7 6 7H12C12.5523 7 13 7.44772 13 8C13 8.55229 12.5523 9 12 9H6C5.44772 9 5 8.55229 5 8Z" fill="#FAFAFA"></path> <path d="M5 12C5 11.4477 5.44772 11 6 11H12C12.5523 11 13 11.4477 13 12C13 12.5523 12.5523 13 12 13H6C5.44772 13 5 12.5523 5 12Z" fill="#FAFAFA"></path> <path d="M5 16C5 15.4477 5.44772 15 6 15H12C12.5523 15 13 15.4477 13 16C13 16.5523 12.5523 17 12 17H6C5.44772 17 5 16.5523 5 16Z" fill="#FAFAFA"></path> </g></svg>
                    <p>Facturas</p>
                </a>
            </li>

            <li>
                <a href="/rectificativas/" class="flex gap-2 pl-5 pr-10 py-4 hover:bg-[#201f1d] border-[#c8c8c8] !border-b-[1px]">
                    <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 193.769 193.769" xml:space="preserve"  fill="#FAFAFA"><path d="m149.203 41.104-9.348 12.009c20.15 15.679 30.201 41.063 26.234 66.253-2.906 18.484-12.838 34.73-27.964 45.748-15.131 11.012-33.64 15.488-52.124 12.567-38.157-6.008-64.32-41.938-58.322-80.098C30.585 79.097 40.52 62.85 55.648 51.835c13.208-9.615 28.991-14.233 45.086-13.317L87.579 52.319l9.759 9.313 20.766-21.801.005.008 9.303-9.769-9.752-9.303-.005.003L95.862 0l-9.31 9.769 14.2 13.525c-19.303-.913-38.21 4.702-54.059 16.242C28.28 52.943 16.19 72.717 12.65 95.221c-7.302 46.445 24.54 90.184 70.985 97.493a86 86 0 0 0 13.434 1.055c17.89 0 35.273-5.623 50.011-16.356 18.415-13.409 30.503-33.183 34.043-55.682 4.829-30.654-7.403-61.55-31.92-80.627"/><path d="M105.24 151.971v-.003h.001v-8.757c10.383-1.159 20.485-7.718 20.485-20.17 0-16.919-15.732-18.859-27.223-20.274-7.347-.878-12.97-1.897-12.97-6.348 0-6.188 8.722-6.855 12.473-6.855 5.567 0 11.507 2.617 13.525 5.957l.586.971 11.542-5.341-.571-1.164c-4.301-8.793-12.009-11.337-17.85-12.364v-7.71H91.723v7.677c-12.582 1.856-20.054 8.839-20.054 18.829 0 16.29 14.791 17.943 25.582 19.153 9.617 1.134 14.094 3.51 14.094 7.469 0 7.563-10.474 8.154-13.685 8.154-7.147 0-14.038-3.566-16.031-8.301l-.495-1.169-12.539 5.316.5 1.169c3.713 8.691 11.725 14.137 22.63 15.425v8.336z"/></svg>
                    <p>Rectificativas</p>
                </a>
            </li>

            <li>
                <a href="/presupuestos/" class="flex gap-2 pl-5 pr-10 py-4 hover:bg-[#201f1d] border-[#c8c8c8] !border-b-[1px]">
            ...
            <li>
                <a href="/gastos/" class="flex gap-2 pl-5 pr-10 py-4 hover:bg-[#201f1d] border-[#c8c8c8] !border-b-[1px]">
            ...
            <li>
                <a href="/contactos/" class="flex gap-2 pl-5 pr-10 py-4 hover:bg-[#201f1d] border-[#c8c8c8] !border-b-[1px]">
                    <svg width="22px" height="22px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#fafafa"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill="none" stroke="#fafafa" stroke-width="2" d="M5,12 C3.343,12 2,10.657 2,9 C2,7.343 3.343,6 5,6 C6.657,6 8,7.343 8,9 C8,10.657 6.657,12 5,12 Z M9,18 L9,16 C9,13.7504 7.2128,12 4.964,12 L5.0184,12 C2.7688,12 1,13.7504 1,16 L1,18 M12,7 L24,7 M12,17 L22,17 M12,12 L19,12"></path> </g></svg>
                    <p>Contactos</p>
                </a>
            </li>
...
<div class="bg-[#fafafafa] mt-[80px] w-full">