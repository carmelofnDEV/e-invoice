        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_top_head tm_mb15 tm_align_center">
            ...
            <?php }else if ($_SERVER['SERVER_PORT'] == '443') {?>
                <div class="tm_logo"><img src="https://<?= $_SERVER['HTTP_HOST'] ?>/static/images/<?=$acc["hash_logo"]?>" alt="Logo"></div>
                ...
                <table>
                  <thead>
                    <tr class="tm_accent_bg">
                      ...
                      <th class="tm_width_2 tm_semi_bold tm_white_color tm_text_right">Importe</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
