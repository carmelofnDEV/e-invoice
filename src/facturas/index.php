...
$add_link = "/documento/nuevo?doc=factura";
            ...
            <div data-url="/documento/ed?doc=factura&item=<?=Intratum\Facturas\Util::getUUIDByID2('inv', $i["id2"]);?>" class="db_div cursor-pointer hover:bg-[#eee] bg-[#ffffff] border-[1px] mb-1 grid grid-cols-5 items-center p-2 rounded-xl">
                ...
                <div>
                    ...
                    <?php } else {?>
                        ...
                        <button id="dropdownDefaul<?=$i["id2"]?>" data-dropdown-toggle="dropdown<?=$i["id2"]?>" class="dropdownDefaul rounded-xl flex items-center bg-[#fff7ec] text-[#ffb145] opacity-80 p-2" type="button">
                            <p class="">Pendiente</p>
                            <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/></svg>
                        </button>
                ...
                <div class="items-center grid grid-cols-2 gap-[50%]">
                    ...
                    <div class="flex items-center gap-5 popover-menu">
                        ...
                        <div data-popover id="popover-<?=$i['id2']?>" role="tooltip" class="popover-menu absolute z-10 invisible inline-block  text- text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800">
                            <div class="">
