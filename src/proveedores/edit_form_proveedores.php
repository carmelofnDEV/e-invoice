...
<div class="pt-[10%]">
    ...
    <div class="flex justify-center ">
        ...
        <form action="" id="form" method="post" class="flex grid grid-cols-2 gap-5 p-10 border-[1px] rounded-xl ">
        ...
        <div class="flex gap-5">
            ...
            <div class="flex gap-5">
                ...
                <div class="mb-5">
                    ...
                    <select oninput="selectCategory(this)" value="<?=$customer["category"]?>" name="category" id="category" class="block w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" required>
                        <option value="f" <?= ($customer["category"] == "f") ? "selected" : "" ?>>Proveedor Fiscal</option>
                        <option value="p" <?= ($customer["category"] == "p") ? "selected" : "" ?>>Proveedor Particular</option>
                    </select>
                </div>
            ...
            <div class="col-span-2 flex justify-end items-end p-3">
                <button type="submit" class="text-white text-[17px] font-[500] bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300  rounded-lg  w-full sm:w-auto px-5 py-1 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Guardar</button>
            </div>
        </form>
