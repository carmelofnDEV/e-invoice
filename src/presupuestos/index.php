...
<div class="py-5 px-10">
    ...
    <div class="w-full ">
        ...
        ?>
            <div data-url="/facturas/ed?item=<?=Intratum\Facturas\Util::getUUIDByID2('inv', $i["id2"]);?>" class="p-3 db_div bg-[#ffffff] border-[1px] mb-1 grid grid-cols-4 items-center p-2 rounded-xl">
                            ...
                            <div class="">
                                <ul class="p-2 flex flex-col justify-center items-center">
                                    ...
                                    <li class="w-full ">
                                        ...
                                        <a href="/facturas/del?item=<?=Intratum\Facturas\Util::getUUIDByID2('inv', $i["id2"]);?>" class="w-full flex gap-3 p-2 hover:bg-[#fafafafa] text-[#FE0000] rounded-md">
