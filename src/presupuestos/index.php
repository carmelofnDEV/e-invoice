...
$title = 'Presupuestos';
$add_link = "/documento/nuevo?doc=presupuesto";
...
<div class="py-5 px-10">
    ...
    <div class="w-full ">
        ...
        ?>
            <div data-url="/documento/ed?doc=presupuesto&item=<?=Intratum\Facturas\Util::getUUIDByID2('inv', $i["id2"]);?>" class="p-3 db_div bg-[#ffffff] border-[1px] mb-1 grid grid-cols-4 items-center p-2 rounded-xl">
