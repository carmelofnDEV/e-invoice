...
<div class="py-5 px-10">
    ...
    <div class="w-full flex justify-between items-end mb-5 gap-2">   
        ...
        <a href="/seriales/nuevo/" id="dropdownCust" class="flex bg-[#1A1917] rounded-md px-3 py-1 justify-center items-center gap-3 " >
    ...
    <div class="w-full ">
        ...
        <?php
            foreach ($all as $i) {
        ?>
            <div data-url="ed?item=<?=Intratum\Facturas\Util::getUUIDByID2('se', $i["id2"]);?>" class="db_div bg-[#ffffff] border-[1px] mb-1 grid grid-cols-2 items-center p-2 rounded-xl">
                            ...
                            <div class="">
                                <ul class="p-2 flex flex-col justify-center items-center">
                                    ...
                                    <li class="w-full flex gap-3 p-2 hover:bg-[#fafafafa] rounded-md text-[#000000]">
                                        ...
                                        <a href="/ed?item=<?=Intratum\Facturas\Util::getUUIDByID2('se', $i["id2"]);?>" class="">Editar</a>    
                                    </li>

                                    <li class="w-full ">

                                        <a href="del?item=<?=Intratum\Facturas\Util::getUUIDByID2('se', $i["id2"]);?>" class="w-full flex gap-3 p-2 hover:bg-[#fafafafa] text-[#FE0000] rounded-md">
