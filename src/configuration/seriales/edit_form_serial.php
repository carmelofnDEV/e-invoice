...
$title = "Editar serial ".$serial["serial_tag"]
?>
...
<form id="form" method="UPDATE" class="max-w-md mx-auto">
    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="relative">
            <input type="text" id="serial_tag"  value="<?= $serial["serial_tag"]?>" name="serial_tag" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
        ...
        <div class="relative">
            <input type="text" id="serial_number"  value="<?= $serial["serial_number"]?>" name="serial_number" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
        ...
        <input type="hidden" name="id2" value="<?= $serial["id2"]?>">
