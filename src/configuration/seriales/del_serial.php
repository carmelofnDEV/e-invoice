...
$title = "Eliminar serial ".$serial["serial_tag"]
?>
...
<div class="flex flex-col justify-center items-center">
    ...
    <form action="" id="form" method="delete" class="max-w-md mx-auto">
        ...
        <a class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" href="/configuracion/seriales/">NO</a>
    </form>
