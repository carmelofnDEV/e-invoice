...
<div class=" flex items-center justify-center flex-col relative overflow-x-auto">

    <a class="m-5 bg-[#638dee] px-[30px] py-[20px] rounded" href="/configuracion/impuestos/nuevo/">
        <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" height="15px" viewBox="0 0 45.402 45.402"
            xml:space="preserve">
            <g>
    ...
    <table class="w-[30%] text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead class=" text-xs text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            ...
            <tr class=" ]bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <p class="text-[15px]"><?= Intratum\Facturas\Util::getUUIDByID2('tax', $i["id2"]) ?></p>
                </th>
                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <p class="text-[20px]"><?=$i["name"]?></p>
                </th>
                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <p class="text-[20px]"><?=$i["value"]?></p>
                </th>
                </th>

                <td class="flex flex-wrap gap-[5px] p-[20px]">
                    <a href="ed?item=<?=Intratum\Facturas\Util::getUUIDByID2('tax', $i["id2"]);?>"
                    ...
                    <a href="del?item=<?=Intratum\Facturas\Util::getUUIDByID2('tax', $i["id2"]);?>"
