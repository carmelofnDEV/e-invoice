                        ...
                        <div data-popover id="popover-<?=$i['id2']?>" role="tooltip" class="absolute z-10 invisible inline-block  text- text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800">
                            <div class="">
                                ...
                                <?php if ($i["type"] == 'p') {?>
                                    ...
                                    <li class="w-full ">
                                        <a href="/facturas/ed?item=<?=Intratum\Facturas\Util::getUUIDByID2('cust', $i["id2"]);?>" class="flex gap-3 p-2 hover:bg-[#fafafafa] rounded-md text-[#000000]">
                                    ...
                                    <li class="w-full ">
                                        ...
                                        <a href="/facturas/del?item=<?=Intratum\Facturas\Util::getUUIDByID2('cust', $i["id2"]);?>" class="w-full flex gap-3 p-2 hover:bg-[#fafafafa] text-[#FE0000] rounded-md">
