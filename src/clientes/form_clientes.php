...
<h2 class="text-center font-[600] text-[20px] mb-5 pt-[10%]">Nuevo cliente</h2>

<div class="flex justify-center ">
    
    <form action="lib/add_producto.php" id="form" method="post" class="flex grid grid-cols-1 gap-5 p-10 border-[1px] rounded-xl">
        ...
        <div class="flex gap-5 ">
            ...
            <div class="mb-5 w-full">
                ...
                <input type="text" id="address_1" name="address1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <div class="flex gap-5">
            <div class="mb-5">
                        ...
                        cliente</label>
                        <select onchange="selectCategory(this)" name="category" id="category" class="block w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" required>
        ...
        <div class="col-span-2 flex justify-end items-end p-3">
            <button type="submit" class="text-white text-[17px] font-[600] bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300  rounded-lg  w-full sm:w-auto px-4 py-1 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Crear</button>
        </div>
...
<script>
    ...
    function selectCategory(item) {
        if ($(item).val() == 'f') {
            ...
            $("#div-responsive-1").addClass("w-full")
            ...
            $("#div-responsive-1").removeClass("w-full")
        }
