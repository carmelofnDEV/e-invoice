...
?>
    ...
    <h2 class="text-center font-[600] text-[20px] mb-5">Nuevo cliente</h2>
    ...
    <button type="submit" class="text-white text-[20px] font-[900] bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300  rounded-lg  w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">+</button>
</form>
    <script>
