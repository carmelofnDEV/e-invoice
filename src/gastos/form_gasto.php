...
<form action="lib/add_producto.php" id="form" class="mt-5" method="post">
                ...
                dark:focus:border-blue-500" placeholder="X" value="" />
                    ...
                    <div class="mb-5 flex justify-center items-center">
                        ...
                        <button id="boton-tax" data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                            class="min-w-[100px] text-[12px] text-white bg-[#d97c2c] hover:bg-[#d97c2c] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg py-2 px-5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            type="button">
    ...
    <div class="flex justify-center">
        ...
        <button type="submit"
            class="text-white text-[20px] font-[900] bg-[#d97c2c] hover:bg-[#d97c2c] focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">+</button>
