...
<div class=" flex items-center flex-col relative overflow-x-auto">
    <h1 class="mb-4 text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-5xl dark:text-white  ">GASTOS</h1>
    <div class="w-[80%] flex justify-around">
        <a class="w-[30%] m-5 bg-[#d97c2c] px-[5%] py-[20px] rounded flex justify-center" href="nuevo/">
        ...
        <div class="w-[30%] flex items-center">   
            ...
            <div class="relative w-full">
                <input type="text" id="searchInput" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#d97c2c] focus:border-[#d97c2c] block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#d97c2c] dark:focus:border-[#d97c2c]" placeholder="Buscar gastos..." required />
            </div>
            <button onclick="buscar()" class="p-2.5 ms-2 text-sm font-medium text-white bg-[#d97c2c] rounded-lg border border-[#d97c2c] hover:bg-[#d97c2c] focus:ring-4 focus:outline-none focus:ring-[#d97c2c] dark:bg-[#d97c2c] dark:hover:bg-[#d97c2c] dark:focus:ring-[#d97c2c]">
